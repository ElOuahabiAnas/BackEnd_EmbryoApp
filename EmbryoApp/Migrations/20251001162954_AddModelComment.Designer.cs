...
namespace EmbryoApp.Migrations
{
    ...
    [Migration("20251001162954_AddModelComment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmbryoApp.Models.ModelRating", b =>
                {
                    b.Property<Guid>("ModelRatingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ModelRatingId");

                    b.HasIndex("ModelId");

                    b.HasIndex("UserId");

                    b.HasIndex("ModelId", "UserId")
                        .IsUnique();

                    b.ToTable("ModelRating", (string)null);
                });
